...
let sendSimpleEmail = async (dataSend) => {
    ...
    let info = await transporter.sendMail({
        from: '"Lưu Hải 👻" <luuhaiskh@gmail.com>', // sender address
...
let getBodyHTMLEmail = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        ...
        <p>Bạn nhận đc email này vì đã đặt lịch khám bệnh online trên bệnh viện Hưng Hà</p>
    ...
    if (dataSend.language === 'en') {
        ...
        <p>You received this email because you booked an online medical appointment at Hung Ha Hospital</p>
